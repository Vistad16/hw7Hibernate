...
public class GetDevelopersCommand implements Command {
	...
	public void process(HttpServletRequest req, HttpServletResponse resp) throws IOException, SQLException {
		...
		Context context = new Context(
				req.getLocale(),
				Map.of("requestsForDevelopers", new RequestsForDeveloper().listAllDeveloper(),
						"sexValues", Developer.Sex.values(),
						"requestsForSkills", new RequestsForSkills().listAllSkills(),
